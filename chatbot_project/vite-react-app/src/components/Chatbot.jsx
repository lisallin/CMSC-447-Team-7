//wherever it deals with how the response is returned, fix the text wrapping issue (a really long url will go off of the box instead of wrapping the text)
//create buttons in here that will ask if undergrad, grad, or faculty then return that choice to the backend 
